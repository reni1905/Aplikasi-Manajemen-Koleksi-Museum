...
Web-Based Museum Collection Management Application for the Cirebon Regency Culture and Tourism Office - As a developer.
# Problems
The cataloging and management of the Pangeran Cakrabuwana Museum's collection are still carried out manually using logbooks or spreadsheets (Microsoft Excel); this makes it difficult for administrators to record, update, and retrieve data, and hinders the department head from quickly obtaining reports on the collection.
# Solutions
Developing a web-based application using the Laravel framework that includes CRUD (Create, Read, Update, Delete) functionality for administrators to manage collection data, as well as a feature for the department head to download reports in PDF format.
# Tech Stack
PHP, MySQL, Laravel, Bootstrap, Visual Studio Code, XAMPP.
# Features:
- [x] CRUD for collection data
- [x] Categorization
- [x] Multi-user login
